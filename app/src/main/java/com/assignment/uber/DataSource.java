...
public class DataSource {
    ...
    private ArrayList<Restaurant> setUpMockData() {
        ...
        restaurant4.setBannerImage(R.drawable.mandys);
        ...
        restaurant5.setBannerImage(R.drawable.ajits_place);
        ...
        restaurant6.setBannerImage(R.drawable.taco_taco);
        ...
        restaurant7.setBannerImage(R.drawable.mcdonalds);
        ...
        restaurant8.setBannerImage(R.drawable.omnivore);
        ...
        restaurant9.setBannerImage(R.drawable.pizza_home);
        ...
        restaurant10.setBannerImage(R.drawable.uniburger);
